...
class Html2Text {
    ...
    function _build_link_list($link, $display) {
        $linkSmall = strtolower($link);
        if (substr($linkSmall, 0, 7) == 'http://' ||
            substr($linkSmall, 0, 8) == 'https://' ||
            substr($linkSmall, 0, 7) == 'mailto:'
        ) {
            $this->_link_count++;
            $this->_link_list .= "[" . $this->_link_count . "] $link\n";
            $additional = ' [' . $this->_link_count . ']';
        } elseif (substr($linkSmall, 0, 11) == 'javascript:') {
